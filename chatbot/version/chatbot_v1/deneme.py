...
def extract_amplitude_series(audio_bytes, frame_duration_ms=100):
    try:
...
# Amplitüd verisini senkronize görselle göster
def sync_amplitude_visuals(amplitudes, interval=0.1):
    def run():
        for amp in amplitudes:
            print(f"Anlık amplitüd: {amp:.3f}")  # burayı animasyon fonksiyonuna bağlayabilirsin
            time.sleep(interval)
...
if __name__ == "__main__":
    speak("Merhaba, bugün size nasıl yardımcı olabilirim?")
